...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-brand-surface selection:bg-brand-accent/20 selection:text-brand-accent overflow-x-hidden">
                ...
                <div className="mt-8 lg:mt-0 lg:absolute lg:bottom-8 lg:right-8 lg:max-w-xs flex flex-col gap-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="glass-card p-5 rounded-[20px] sm:rounded-[24px] border-white/10 backdrop-blur-xl bg-white/10 lg:bg-brand-dark/20">
                      ...
                      <div className="text-xl sm:text-2xl font-light text-white tracking-tight">18+</div>
                    </div>
      ...
      {/* Contact Section */}
      <section id="contato" className="py-24 sm:py-32 relative bg-premium-ambient overflow-hidden">
        <div className="blueprint-grid opacity-[0.02]" />
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto mb-16 sm:mb-20">
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-accent/5 mb-6 sm:mb-8"
            >
              <div className="w-1.5 h-1.5 rounded-full bg-brand-accent" />
              <span className="text-[10px] font-black tracking-[.2em] uppercase text-brand-accent/80">Canais de Atendimento</span>
            </motion.div>
            <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              className="text-4xl sm:text-5xl md:text-7xl font-extrabold mb-6 sm:mb-8 tracking-tighter text-brand-text leading-tight"
            >
              Pronto para <span className="text-dynamic-accent">começar?</span>
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              className="text-brand-muted text-base sm:text-lg md:text-xl font-light leading-relaxed max-w-3xl mx-auto"
            >
              Nossos profissionais são altamente qualificados para atuar na avaliação de imóveis, elaboração de laudos e manuais, bem como realizar vistorias e perícias. <br /><br />
              Prezamos pelo atendimento de excelência e com agilidade para apresentar as melhores alternativas frente aos projetos de nossos clientes. Não deixe de falar conosco sobre o seu projeto
            </motion.p>
          </div>

          <div className="grid md:grid-cols-2 gap-8 sm:gap-10 max-w-5xl mx-auto mb-16 sm:mb-24">
            <motion.a 
              href="https://wa.me/5522992436434"
              target="_blank"
              ...
              viewport={{ once: true, margin: "-100px" }}
              className="group glass-card-accent p-8 sm:p-10 rounded-[32px] sm:rounded-[40px] flex items-center gap-6 sm:gap-8 hover:-translate-y-2 transition-all duration-500"
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-brand-accent text-white rounded-[20px] sm:rounded-[28px] flex items-center justify-center shrink-0 shadow-2xl shadow-brand-accent/30 group-hover:scale-110 transition-transform duration-500">
                <Phone size={28} className="sm:hidden" strokeWidth={1.5} />
                <Phone size={36} className="hidden sm:block" strokeWidth={1.5} />
              </div>
              <div>
                <h4 className="text-xl sm:text-2xl font-extrabold mb-1 text-brand-text tracking-tighter">WhatsApp</h4>
                <p className="text-brand-muted mb-2 sm:mb-4 font-mono text-xs sm:text-sm">(22) 99243-6434</p>
                <div className="inline-flex items-center gap-2 text-brand-accent font-black text-[9px] sm:text-[10px] uppercase tracking-[0.2em] group-hover:gap-4 transition-all">Iniciar Conversa <ArrowRight size={14} /></div>
              </div>
            </motion.a>
            ...
            <motion.a 
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true, margin: "-100px" }}
              className="group glass-card p-8 sm:p-10 rounded-[32px] sm:rounded-[40px] flex items-center gap-6 sm:gap-8 hover:-translate-y-2 transition-all duration-500 bg-white/80"
            >
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white border border-brand-accent/10 text-brand-accent rounded-[20px] sm:rounded-[28px] flex items-center justify-center shrink-0 shadow-sm transition-all duration-500 group-hover:bg-brand-accent group-hover:text-white group-hover:scale-110">
                <Mail size={28} className="sm:hidden" strokeWidth={1.5} />
                <Mail size={36} className="hidden sm:block" strokeWidth={1.5} />
              </div>
              <div>
                <h4 className="text-xl sm:text-2xl font-extrabold mb-1 text-brand-text tracking-tighter">E-mail</h4>
                <p className="text-brand-muted mb-2 sm:mb-4 text-[10px] sm:text-xs opacity-80 break-all uppercase tracking-wider">tmcsolucoesengenharia@gmail.com</p>
                <div className="inline-flex items-center gap-2 text-brand-accent font-black text-[9px] sm:text-[10px] uppercase tracking-[0.2em] group-hover:gap-4 transition-all">Enviar E-mail <ArrowRight size={14} /></div>
              </div>
            </motion.a>
          </div>
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            className="glass-card p-10 sm:p-12 md:p-16 rounded-[40px] sm:rounded-[60px] flex flex-col md:flex-row items-center gap-8 sm:gap-12 max-w-5xl mx-auto shadow-2xl bg-white/60"
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-brand-accent/10 rounded-full flex items-center justify-center text-brand-accent shrink-0 shadow-inner">
              <MapPin size={32} className="sm:hidden" strokeWidth={1.5} />
              <MapPin size={40} className="hidden sm:block" strokeWidth={1.5} />
            </div>
            <div className="text-center md:text-left flex-1">
              <h4 className="text-2xl sm:text-3xl font-extrabold mb-3 text-brand-text tracking-tighter">Escritório Macaé</h4>
              <p className="text-brand-muted text-lg sm:text-xl leading-relaxed font-light">
                Rua Teixeira de Gouveia, Nº 1169, <br />
                Sala 208, Centro, Macaé/RJ <br />
                <span className="text-brand-accent font-mono text-xs sm:text-sm font-bold tracking-tighter mt-4 block">CEP: 27910-110</span>
              </p>
            </div>
            <div className="w-full lg:w-1/3 aspect-video lg:aspect-square rounded-[32px] sm:rounded-[48px] overflow-hidden border border-brand-accent/10 shadow-inner group/map">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3688.081186716264!2d-41.7820556!3d-22.373406!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x962e2fd6e4a6d1%3A0x6b4c107f9c8d655f!2sR.%20Teixeira%20de%20Gouveia%2C%201169%20-%20Centro%2C%20Maca%C3%A9%20-%20RJ%2C%2027910-110!5e0!3m2!1spt-BR!2sbr!4v1713460000000!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                ...
                className="grayscale transition-all duration-700 group-hover/map:grayscale-0"
              />
            </div>
          </motion.div>
        </div>
